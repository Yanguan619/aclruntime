...
from ais_bench.benchmark.partitioners import PerformancePartitioner
from ais_bench.benchmark.runners.local_api import LocalAPIRunner
from ais_bench.benchmark.partitioners import PerformancePartitioner
from ais_bench.benchmark.tasks import  OpenICLPerfTask
...
infer=dict(
            partitioner=dict(type=PerformancePartitioner),
            runner=dict(
                max_num_workers=2,
                concurrent_users=2,
                debug=True,
                task=dict(type=OpenICLPerfTask),
                type=(LocalAPIRunner)
            ))
