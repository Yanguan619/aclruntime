...
class TestClass:
    ...
    def get_dymaipp_staticshape_om_path(cls):
        return os.path.join(
            ...
            cls.model_name,
            "model",
            "pth_resnet50_bs4_dymaipp_stcbatch.om",
        )
    ...
    def get_dymaipp_dymbatch_om_path(cls):
        return os.path.join(
            ...
            cls.model_name,
            "model",
            "pth_resnet50_dymaipp_dymbatch.om",
        )
    ...
    def get_aipp_config_param_overflowed(cls):
        return os.path.join(
            ...
            "../",
            "aipp_config_files",
            "actual_aipp_cfg_param_overflowed.config",
        )
    ...
    def get_aipp_config_lack_param(cls):
        return os.path.join(
            ...
            "../",
            "aipp_config_files",
            "actual_aipp_cfg_lack_param.config",
        )
    ...
    def get_aipp_config_multi_input(cls):
        return os.path.join(
            ...
            "../",
            "aipp_config_files",
            "actual_aipp_cfg_multi_input.config",
        )
    ...
    def get_aipp_config_lack_title(cls):
        return os.path.join(
            ...
            "../",
            "aipp_config_files",
            "actual_aipp_cfg_lack_title.config",
        )
    ...
    def get_aipp_config_all_params(cls):
        return os.path.join(
            ...
            "../",
            "aipp_config_files",
            "actual_aipp_cfg_all_params.config",
        )
    ...
    def test_infer_aipp_cfg_param_overflowed(self):
        ...
        session.check_dym_aipp_input_exist()
        with pytest.raises(Exception):
            aipp_manager = DymAippManager(
                session, self.get_aipp_config_param_overflowed(), 4
            )
            aipp_manager.load_aipp_config_content()
            session.set_dym_aipp_info_set()
            logger.info("get --aipp_config wrong")
