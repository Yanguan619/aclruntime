...
DEFINE_MOCK_C_API(aclError, aclrtMallocHost, (void** ptr, size_t size), (ptr, size))
DEFINE_MOCK_C_API(aclError, aclrtFreeHost, (void* hostData), (hostData))
DEFINE_MOCK_C_API(aclError, acldvppMalloc, (void** ptr, size_t size), (ptr, size))
...
DEFINE_MOCK_C_API(aclError, aclrtCreateContext, (void** context, int devId), (context, devId))
