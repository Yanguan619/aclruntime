...
class TestClass:
    ...
    def test_vllm_api_infer_qwen2_7b_default(self, monkeypatch):
        ...
        monkeypatch.setattr('sys.argv', ["ais_bench", "--models", "vllm_api_qwen2_7b_instruct", "--datasets", "gsm8k_gen", "-w", self.test_data_path])
        ...
        main()
        result_json_path = os.path.join(self.test_data_path, f"{fake_time_str}/predictions/vllm-api-qwen2-7b-instruct/gsm8k.json")
    ...
    def test_vllm_api_infer_baichuan2_7b_default(self, monkeypatch):
        ...
        monkeypatch.setattr('sys.argv', ["ais_bench", "--models", "vllm_api_baichuan2_7b_base", "--datasets", "gsm8k_gen", "-w", self.test_data_path])
        monkeypatch.setattr("ais_bench.benchmark.models.vllm_custom_api.VLLMCustomAPI._get_service_model_path", lambda *arg: "qwen2")
        monkeypatch.setattr("ais_bench.benchmark.models.vllm_custom_api.VLLMCustomAPI._generate", lambda *arg: fake_prediction)
        monkeypatch.setattr("ais_bench.benchmark.cli.main.get_current_time_str", lambda *arg: fake_time_str)
        main()
        result_json_path = os.path.join(self.test_data_path, f"{fake_time_str}/predictions/vllm-api-baichuan2-7b-base/gsm8k.json")
        assert os.path.exists(result_json_path)
        with open(result_json_path, 'r', encoding='utf-8') as file:
            data = json.load(file)
        assert len(data) == GSK8K_DATA_COUNT
    ...
    def test_vllm_api_infer_llama3_8b_default(self, monkeypatch):
        ...
        monkeypatch.setattr('sys.argv', ["ais_bench", "--models", "vllm_api_llama3_8b", "--datasets", "gsm8k_gen", "-w", self.test_data_path])
        monkeypatch.setattr("ais_bench.benchmark.models.vllm_custom_api.VLLMCustomAPI._get_service_model_path", lambda *arg: "qwen2")
        monkeypatch.setattr("ais_bench.benchmark.models.vllm_custom_api.VLLMCustomAPI._generate", lambda *arg: fake_prediction)
        monkeypatch.setattr("ais_bench.benchmark.cli.main.get_current_time_str", lambda *arg: fake_time_str)
        main()
        result_json_path = os.path.join(self.test_data_path, f"{fake_time_str}/predictions/vllm-api-llama3-8b/gsm8k.json")
        assert os.path.exists(result_json_path)
        with open(result_json_path, 'r', encoding='utf-8') as file:
            data = json.load(file)
        assert len(data) == GSK8K_DATA_COUNT
