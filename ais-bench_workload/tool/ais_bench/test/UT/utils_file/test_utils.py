...
class TestYourModule(unittest.TestCase):
    ...
    def test_create_tmp_acl_json(self, mock_os_remove, mock_json_load, mock_ms_open):
        ...
        mock_ms_open.return_value.__enter__.return_value.read.return_value = '{"dump": {"dump_path": "dump"}}'
    ...
    def test_convert_helper(self, mock_subprocess_call, mock_get_msaccucmp_path, mock_get_dump_relative_paths):
    ...
    @patch('ais_bench.infer.common.utils.get_msaccucmp_path')
    @patch('ais_bench.infer.common.utils.subprocess.call')
    def test_convert_helper1(self, mock_subprocess_call, mock_get_msaccucmp_path, mock_get_dump_relative_paths):
        # Mock get_dump_relative_paths, get_msaccucmp_path, and subprocess.call
        mock_get_dump_relative_paths.return_value = ['/path/to/dump']
    ...
    @patch('ais_bench.infer.common.utils.get_msaccucmp_path')
    @patch('ais_bench.infer.common.utils.subprocess.call')
    def test_convert_helper2(self, mock_subprocess_call, mock_get_msaccucmp_path, mock_get_dump_relative_paths):
        # Mock get_dump_relative_paths, get_msaccucmp_path, and subprocess.call
