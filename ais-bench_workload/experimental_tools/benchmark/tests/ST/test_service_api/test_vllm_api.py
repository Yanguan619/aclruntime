...
class TestClass:
    ...
    def test_vllm_api_general_all_lambada(self, monkeypatch):
        fake_prediction = "11"
    ...
    def test_vllm_api_general_all_lcsts(self, monkeypatch):
        fake_prediction = "11"
        fake_time_str = "vllm_lcsts_gen_0_shot_str"
        datasets_abbr_name = "lcsts"
        datasets_script_name = "lcsts_gen_0_shot_str"
    ...
    def test_vllm_api_general_all_siqa(self, monkeypatch):
        fake_prediction = "11"
        fake_time_str = "vllm_siqa_gen_0_shot_str"
        datasets_abbr_name = "siqa"
        datasets_script_name = "siqa_gen_0_shot_str"
    ...
    def test_vllm_api_general_all_xsum(self, monkeypatch):
        fake_prediction = "11"
