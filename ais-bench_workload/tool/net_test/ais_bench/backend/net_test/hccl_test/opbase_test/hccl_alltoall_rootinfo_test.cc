...
int HcclOpBaseAlltoallTest::InitBufVal()
{
    // 初始化输入内存
...
int HcclOpBaseAlltoallTest::CheckBufResult()
{
    // 获取输出内存
...
int HcclOpBaseAlltoallTest::CalExecutionTime(float time)
{
...
void HcclOpBaseAlltoallTest::FreeSendRecvBuf()
{
}

int HcclOpBaseAlltoallTest::DestoryCheckBuf()
{
...
int HcclOpBaseAlltoallTest::HcclOpBaseTestMain() // 主函数
{
