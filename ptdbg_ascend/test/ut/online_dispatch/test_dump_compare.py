...
import torch
import numpy as np
from src.python.ptdbg_ascend.online_dispatch.dump_compare import DispatchRunParam, TimeStatistics, get_compare_result, save_summery, support_basic_type, dump_data, compare_data, save_temp_summery, dispatch_workflow, get_torch_func, dispatch_multiprocess, save_csv
...
class TestDumpCompare(unittest.TestCase):
    ...
    @patch('src.python.ptdbg_ascend.online_dispatch.dump_compare.np_save_data')
    ...
    @patch('src.python.ptdbg_ascend.online_dispatch.dump_compare.json.dump')
    ...
    @patch('src.python.ptdbg_ascend.online_dispatch.dump_compare.compare_data')
    @patch('src.python.ptdbg_ascend.online_dispatch.dump_compare.dump_data')
    ...
    @patch('src.python.ptdbg_ascend.online_dispatch.dump_compare.dispatch_workflow')
    ...
    @patch('src.python.ptdbg_ascend.online_dispatch.dump_compare.pd.DataFrame')
