...
namespace Base {
    ...
    APP_ERROR MemoryHelper::specificMalloc(MemoryData& data) {
        ...
        case MemoryData::MEMORY_DEVICE:
            // ACL_MEM_MALLOC_HUGE_FIRST: https://www.hiascend.com/document/detail/zh/canncommercial/900/API/runtimeapi/aclcppdevg_03_1349.html
            ret = aclrtMallocAlign32(&(data.ptrData), data.size, ACL_MEM_MALLOC_HUGE_FIRST);
