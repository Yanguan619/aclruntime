...
class TestClass:
    ...
    def test_vllm_api_general_perf_videobench(self, monkeypatch):
        ...
        fake_time_str = "videobench_fake_time"
        datasets_abbr_name = "videobenchdataset"
        datasets_script_name = "videobench_gen"
        ...
        # check perf json
        infer_outputs_json_path = os.path.join(self.test_data_path, f"{fake_time_str}/performances/vllm-api-general/{datasets_abbr_name}.json")
        ...
        #check perf csv
        infer_outputs_csv_path = os.path.join(self.test_data_path, f"{fake_time_str}/performances/vllm-api-general/{datasets_abbr_name}.csv")
