...
class TestClass:
    ...
    def test_triton_api_general_all_default(self, monkeypatch):
        ...
        # check infer out
        infer_outputs_json_path = os.path.join(self.test_data_path, f"{fake_time_str}/predictions/triton-api-general/{datasets_abbr_name}.json")
        ...
        # check eval out
        results_json_path = os.path.join(self.test_data_path, f"{fake_time_str}/results/triton-api-general/{datasets_abbr_name}.json")
