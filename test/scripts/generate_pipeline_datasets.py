...
base_path = os.getcwd()
cur_bin_aipp_path = os.path.join(
    base_path, "testdata/resnet50/input/fake_dataset_bin_aipp"
)
...
cur_bin_nor_path = os.path.join(
    base_path, "testdata/resnet50/input/fake_dataset_bin_nor"
)
...
cur_npy_aipp_path = os.path.join(
    base_path, "testdata/resnet50/input/fake_dataset_npy_aipp"
)
...
cur_npy_nor_path = os.path.join(
    base_path, "testdata/resnet50/input/fake_dataset_npy_nor"
)
