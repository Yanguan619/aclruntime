...
class TestClass:
    ...
    def get_output_dir_bin(cls):
        return os.path.realpath(
            os.path.join(
                TestCommonClass.get_basepath(), cls.model_name, "output", "bin_out"
            )
        )
    ...
    def get_output_dir_npy(cls):
        return os.path.realpath(
            os.path.join(
                TestCommonClass.get_basepath(), cls.model_name, "output", "npy_out"
            )
        )
