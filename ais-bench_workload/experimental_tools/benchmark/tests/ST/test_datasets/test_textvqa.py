...
class TestClass:
    ...
    def test_vllm_api_general_perf_textvqa(self, monkeypatch):
        ...
        fake_time_str = "textvqa_fake_time"
        datasets_abbr_name = "textvqadataset"
        datasets_script_name = "textvqa_gen"
