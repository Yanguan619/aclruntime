...
class TestClass:
    ...
    def test_infer_api_static(self):
        ...
        session.infer([ndata], mode="static")
    ...
    def test_infer_api_dymbatch(self):
        ...
        # in is numpy list and output is numpy list
        session.infer([ndata], mode="dymbatch")
    ...
    def test_infer_api_dymwh(self):
        ...
        # in is numpy list and output is numpy list
        session.infer([ndata], mode="dymhw")
    ...
    def test_infer_api_dymdim(self):
        ...
        # in is numpy list and output is numpy list
        session.infer([ndata], mode="dymdims")
    ...
    def test_infer_pipeline_api_static(self):
        ...
        # in is numpy list and output is numpy list
        session.infer_pipeline(ndata_list, mode="static")
    ...
    def test_infer_pipeline_api_dymbatch(self):
        ...
        # in is numpy list and output is numpy list
        session.infer_pipeline(ndata_list, mode="dymbatch")
    ...
    def test_infer_pipeline_api_dymwh(self):
        ...
        # in is numpy list and output is numpy list
        session.infer_pipeline(ndata_list, mode="dymhw")
    ...
    def test_infer_pipeline_api_dymdim(self):
        ...
        # in is numpy list and output is numpy list
        session.infer_pipeline(ndata_list, mode="dymdims")
