...
class TestClass:
    ...
    def test_vllm_api_general_perf_vocalsound(self, monkeypatch):
        ...
        fake_time_str = "vocalsound_fake_time"
        datasets_abbr_name = "vocalsounddataset"
        datasets_script_name = "vocalsound_gen"
