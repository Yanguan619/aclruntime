...
def infer_torch_tensor():
    ...
    logger.info(
        f"in torch tensor outputs[0].shape:{outputs[0].shape} type:{type(outputs)}"
    )
    ...
    logger.info(
        f"in discontinuous torch tensor outputs[0].shape:{outputs[0].shape} type:{type(outputs)}"
    )
...
def infer_dymshape():
    ...
    logger.info(
        f"inputs: custom_sizes: {output_size} outputs:{outputs} type:{type(outputs)}"
    )
    ...
    logger.info(
        f"inputs: custom_sizes: {output_sizes} outputs:{outputs} type:{type(outputs)}"
    )
