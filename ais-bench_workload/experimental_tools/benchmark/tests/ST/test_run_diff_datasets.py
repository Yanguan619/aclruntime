...
class TestClass:
    ...
    def test_vllm_api_all_qwen2_7b_lambada_0_shot(self, monkeypatch):
        fake_prediction = "11"
        fake_time_str = "lambada_0_shot"
        datasets_abbr_name = "lambada"
        datasets_script_name = "lambada_gen_0_shot_chat"
        monkeypatch.setattr('sys.argv',
            ["ais_bench", "--models", "vllm_api_general", "--datasets", datasets_script_name,
            "--mode", "all", "-w", self.test_data_path])
        monkeypatch.setattr("ais_bench.benchmark.models.vllm_custom_api.VLLMCustomAPI._get_service_model_path", lambda *arg: "qwen2")
    ...
    def test_vllm_api_all_qwen2_7b_lcsts_0_shot(self, monkeypatch):
        fake_prediction = "11"
        fake_time_str = "lcsts_0_shot"
        datasets_abbr_name = "lcsts"
        datasets_script_name = "lcsts_gen_0_shot_chat"
        monkeypatch.setattr('sys.argv',
            ["ais_bench", "--models", "vllm_api_general", "--datasets", datasets_script_name,
            "--mode", "all", "-w", self.test_data_path])
        monkeypatch.setattr("ais_bench.benchmark.models.vllm_custom_api.VLLMCustomAPI._get_service_model_path", lambda *arg: "qwen2")
    ...
    def test_vllm_api_all_qwen2_7b_siqa_0_shot(self, monkeypatch):
        fake_prediction = "11"
        fake_time_str = "siqa_0_shot"
        datasets_abbr_name = "siqa"
        datasets_script_name = "siqa_gen_0_shot_chat"
        monkeypatch.setattr('sys.argv',
            ["ais_bench", "--models", "vllm_api_general", "--datasets", datasets_script_name,
            "--mode", "all", "-w", self.test_data_path])
        monkeypatch.setattr("ais_bench.benchmark.models.vllm_custom_api.VLLMCustomAPI._get_service_model_path", lambda *arg: "qwen2")
    ...
    def test_vllm_api_all_qwen2_7b_xsum_0_shot(self, monkeypatch):
        fake_prediction = "11"
        fake_time_str = "xsum_0_shot"
        datasets_abbr_name = "Xsum"
        datasets_script_name = "xsum_gen_0_shot_chat"
        monkeypatch.setattr('sys.argv',
            ["ais_bench", "--models", "vllm_api_general", "--datasets", datasets_script_name,
            "--mode", "all", "-w", self.test_data_path])
        monkeypatch.setattr("ais_bench.benchmark.models.vllm_custom_api.VLLMCustomAPI._get_service_model_path", lambda *arg: "qwen2")
