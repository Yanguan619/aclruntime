...
from ais_bench.infer.summary import (
    Summary,
    Result,
    ListInfo,
...
class TestSummary(unittest.TestCase):
    ...
    def test_add_sample_id_infiles(self):
        ...
        self.assertEqual(
            self.summary.infodict["filesinfo"][sample_id]["infiles"], infiles
        )
    ...
    def test_append_sample_id_outfile(self):
        ...
        self.assertEqual(
            self.summary.infodict["filesinfo"][sample_id]["outfiles"], [outfile]
        )
    ...
    def test_record(self, mock_logger):
        ...
        self.assertEqual(
            self.summary.infodict["NPU_compute_time"]["percentile(99%)"], 4.95
        )
