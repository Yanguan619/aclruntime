...
int HcclOpBaseReducescatterTest::CheckBufResult()
{
    // 获取输出内存
...
int HcclOpBaseReducescatterTest::CalExecutionTime(float time)
{
...
int HcclOpBaseReducescatterTest::DestoryCheckBuf()
{
...
int HcclOpBaseReducescatterTest::HcclOpBaseTestMain() // 主函数
{
    // 获取数据量和数据类型
    InitDataCount();
