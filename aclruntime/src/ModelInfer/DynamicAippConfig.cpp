...
bool DynamicAippConfig::IsActivated() { return isActivated; }

bool DynamicAippConfig::ModelIsLegal() { return modelOK; }

void DynamicAippConfig::ActivateConfig() { isActivated = true; }

void DynamicAippConfig::ActivateModel() { modelOK = true; }
...
APP_ERROR DynamicAippConfig::SetPixelVarReci(
    std::vector<float> reciInputParams) {
...
int32_t DynamicAippConfig::GetSrcImageSizeW() { return srcImageSizeW; }

int32_t DynamicAippConfig::GetSrcImageSizeH() { return srcImageSizeH; }

int8_t DynamicAippConfig::GetRbuvSwapSwitch() { return rbuvSwapSwitch; }

int8_t DynamicAippConfig::GetAxSwapSwitch() { return axSwapSwitch; }

CscParams DynamicAippConfig::GetCscParams() { return cscParams; }

std::unordered_map<uint64_t, CropParams> DynamicAippConfig::GetCropParams() {
    return cropParams;
}

std::unordered_map<uint64_t, PaddingParams>
DynamicAippConfig::GetPaddingParams() {
    return paddingParams;
}

std::unordered_map<uint64_t, DtcPixelMean>
DynamicAippConfig::GetDtcPixelMean() {
...
std::unordered_map<uint64_t, PixelVarReci>
DynamicAippConfig::GetPixelVarReci() {
