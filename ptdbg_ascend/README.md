...
1. whl包获取。
   ...
   | ---------------- | --------- | ---------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
   | 2.3            | 2023-6-20 | 1.8.1/1.11.0/2.0 | [ptdbg_ascend-2.3-py3-none-any.whl](https://ptdbg.obs.myhuaweicloud.com/package/ptdbg_ascend/2.0/ptdbg_ascend-2.3-py3-none-any.whl) | [ptdbg_ascend精度工具功能说明](doc/ptdbg_ascend精度工具功能说明.md) |
